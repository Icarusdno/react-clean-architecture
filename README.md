...
Приписка **Mutation** используется в названии функции, чтобы избежать коллизий имен при использовании в юзкейсах.
...
Приписка **Query** используется в названии функции, чтобы избежать коллизий имен при использовании в юзкейсах.
